...
export default {
  data() {
    return {
      brands: [
        {name: 'RSP Nutrition', images: 'rsp-nutrition-logo'},
        {name: 'Rule One Proteins', images: 'rule-1-logo'},
        {name: 'Mutant', images: 'mutant-logo'},
        {name: 'Blackmores', images: 'blackmores-logo'},
        {name: 'Elitelabs', images: 'elitelabs-logo'},
        {name: 'Untimate Nutrition', images: 'untimatenutrition-logo'},
        {name: 'Optimum Nutrition', images: 'optimum-nutrition-logo'},
        {name: 'Wheylabs', images: 'wheylabs-logo'},
        {name: 'Myprotein', images: 'myprotein-logo'}
      ],
      products: [
        {name: 'Sữa Tăng Cơ Applied Nutrition ISO-XP 1.8kg - 72 Lần Dùng', images: 'product_1', price: '1,785,000 '},
        {name: 'Viên Uống Đốt Mỡ Nutrex Lipo-6 Black Stim-Free 60 Viên', images: 'product_2', price: '800,000 '},
        {name: 'Sữa Tăng Cơ Giảm Mỡ Rule One Protein R1 Protein 2.27kg', images: 'product_3', price: '1,800,000 '},
        {name: 'BPI ISO HD 4.8lbs (2.17kg) - 100% Pure Whey Protein Isolate', images: 'product_4', price: '1,598,000 '},
